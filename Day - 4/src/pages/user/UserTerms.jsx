  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      <div className="container mx-auto px-4 py-0.1 mb-16 mt-24">
        ...
        <p className="mb-4">
          Welcome to Starry Ni8's! These terms and conditions govern your use of
          our website and mobile application ("Starry Ni8's"). By accessing or using
        ...
        <p className="mb-2">
          ...
          any content you submit to our Platform, including event reviews,
