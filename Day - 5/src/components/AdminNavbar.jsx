...
export default function AdminNavbar() {
  ...
  return (
    <div>
      <nav className="bg-gray-800 text-white flex flex-col md:flex-row justify-between items-center py-2 px-5 fixed w-full top-0 shadow-lg">
              ...
              <div className="relative group">
                ...
                {showProfileMenu && (
                  ...
                  >
                    <ul className="py-2">
                      <li>
                        <Link to='/admin/profile' className="block px-4 py-2 text-gray-800 hover:bg-gray-200">
                          Your Profile
                        </Link>
                      </li>
                      <li>
