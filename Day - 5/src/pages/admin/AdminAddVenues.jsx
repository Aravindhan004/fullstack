...
export default function AddVenues({ setOpen }) {
            ...
            <Box sx={{ pr: 3, pl: 3 }}>
                <Box>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mt: 3 }}>
                        ...
                        <TextField onChange={(e) => setBook({...book, authorname: e.target.value})} size='small' id='Authorname' label='Location' name='Authorname' required />
                    </Box>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between'}}>
                        <TextField sx={{ mt: 3 }} onChange={(e) => setBook({...book, dop: e.target.value})} size='small' id='dop' label='Type' name='dop' required />
                        <TextField sx={{ mt: 3 }} onChange={(e) => setBook({...book, genre: e.target.value})} size='small' id='genre' label='Suitable For' name='genre' required />
                    </Box>
                    {/* <Box sx={{ display: 'flex', justifyContent: 'space-between'}}>
